/*!
 * Lichu
 * Lichu <hekailiu@foxmail.com>
 */
(function ($) {
  "use strict";

  var Lichu_VERSION = "1.0.0";
  ...
  var postlikeConfig = function () {
    $.fn.postLike = function () {
      if ($(this).hasClass("done")) {
        layer.msg(Lichu.repeat, function () {});
        return false;
      } else {
        $(this).addClass("done");
        layer.msg(Lichu.thanks);
        var id = $(this).data("id"),
        ...
        $.post(
          Lichu.site + "/wp-admin/admin-ajax.php",
          ajax_data,
          function (data) {}
        );
        return false;
  ...
  var consoleConfig = function () {
    console.log(
      "\n Lichu v" +
        Lichu_VERSION +
        "\n\n https://github.com/hekailiu-2512/Lichu \n\n"
    );
  };
