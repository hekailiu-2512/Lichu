...
if (!empty(Lichu_option('g_cos_fieldset')['g_cos'])) {
    function dogcloud_upload($object, $file, $mime)
    {
        ...
        if (@file_exists($file)) {
            $accessKey = Lichu_option('g_cos_fieldset')['g_cos_accesskey'];
            $secretKey = Lichu_option('g_cos_fieldset')['g_cos_secretkey'];
            $bucket = Lichu_option('g_cos_fieldset')['g_cos_bucketname'];
    ...
    {
        $upload_path = '';
        $upload_url_path = Lichu_option('g_cos_fieldset')['g_cos_url'];
