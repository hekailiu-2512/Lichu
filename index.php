    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 board">
                <?php if (is_home() && Lichu_option('g_carousel', false)) {
                    Lichu_carousel();
                }
                if (is_search()) { ?>
                    <div class="article-panel">
                        <div class="search-title"><?php _e('搜索内容：', 'Lichu');
                ...
                if (have_posts()) {
                    ...
                    <div class="article-panel">
                        <div class="nothing">
                            <img src="<?php echo Lichu_option('g_nothing', ASSET_PATH . '/assets/img/nothing.svg'); ?>">
                            <div class="sorry"><?php _e('很抱歉，没有找到任何内容', 'Lichu'); ?></div>
                        </div>
                    </div>
                <?php }
                pagelist();
